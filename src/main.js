...
class main extends Component {
  ...
  async getNewProjectsPage() {
    var data = [];
    const promise1 = fetch("https://us-central1-portfolio-6b427.cloudfunctions.net/getProjects").then(res => res.json())
    const promise2 = fetch("https://us-central1-portfolio-6b427.cloudfunctions.net/getNewProjects").then(res => res.json())
