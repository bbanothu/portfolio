            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <TabList
                      className="rwt__tab shadow p-3 mb-5 bg-white rounded mt-4 ml-3 "
                      style={{ height: "100%", width: "75%" }}
                    >


                      <Tab eventKey="contact" title="Contact" disabled tabFor=""
                  ...
                  >
                    <TabList
                      ...
                      style={{ height: "100%", width: "75%" }}
                    >
                      <Tab title="Contact" disabled tabFor=""
                        style={{ textAlign: "center", fontWeight: "bold", color: "black" }}
